...
# PORT=29501 CUDA_VISIBLE_DEVICES=0,1,2,3 ./tools/dist_train.sh configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/crowdpose/res50_crowdpose_256x192.py 4 --work-dir work_dirs/res50_crowdpose_256x192 --cfg-options data.train_dataloader.samples_per_gpu=8 data.workers_per_gpu=0 
