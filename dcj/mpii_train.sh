...
# PORT=29502 CUDA_VISIBLE_DEVICES=0 ./tools/dist_train.sh configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/mpii/litehrnet_18_mpii_256x256.py 1 --work-dir work_dirs/litehrnet_18_mpii_256x256 --cfg-options data.train_dataloader.samples_per_gpu=8 data.workers_per_gpu=0
...
# 2022-10-25 16:44:26,944 - mmpose - INFO - Epoch [1][50/696]     lr: 4.945e-05, eta: 2 days, 16:26:33, time: 1.588, data_time: 1.243, memory: 4045, heatmap_loss: 0.0027, acc_pose: 0.0617, loss: 0.0027

# PORT=29502 CUDA_VISIBLE_DEVICES=0,1,2,3 ./tools/dist_train.sh configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/mpii/litehrnet_18_mpii_256x256.py 4 --work-dir work_dirs/litehrnet_18_mpii_256x256 --cfg-options data.train_dataloader.samples_per_gpu=16 data.workers_per_gpu=0
# 2022-10-25 16:54:56,771 - mmpose - INFO - Epoch [1][50/348]     lr: 4.945e-05, eta: 1 day, 3:37:49, time: 1.362, data_time: 0.780, memory: 2038, heatmap_loss: 0.0027, acc_pose: 0.0701, loss: 0.0027
...
PORT=29503 CUDA_VISIBLE_DEVICES=0,1,2,3 ./tools/dist_train.sh configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/mpii/mobilenetv2_mpii_256x256.py 4 --work-dir work_dirs/mobilenetv2_mpii_256x256 --cfg-options data.train_dataloader.samples_per_gpu=1 data.workers_per_gpu=0
